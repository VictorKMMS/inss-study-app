...
export const allQuestionBanks = {
    ...
    etica: [
        ...
        { id: "Q16", question: 'É vedado ao servidor público federal ligar seu nome a empreendimentos de cunho duvidoso.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Esta é uma das vedações expressas no Decreto nº 1.171/1994, que visa preservar a honra e a imagem do serviço público.' },
        { id: "Q17", question: 'O servidor público pode, injustificadamente, deixar de participar de estudos que se relacionem com a melhoria do exercício de suas funções, pois essa ação não constitui dever fundamental.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'É um dever fundamental do servidor público manter-se atualizado e participar de atividades de capacitação para a melhoria do serviço, conforme o Código de Ética.' },
        { id: "Q18", question: 'Caso um ministro de Estado pretenda realizar consulta sobre matéria de ética pública, a consulta deverá ser dirigida à Comissão de Ética Pública (CEP).', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O Decreto nº 6.029/2007 estabelece que a CEP é a instância consultiva máxima para presidentes, ministros e dirigentes de entidades do Poder Executivo Federal.' },
        { id: "Q19", question: 'As autoridades competentes poderão alegar sigilo para deixar de prestar informação solicitada pelas comissões de ética.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'O Decreto nº 6.029/2007 veda expressamente que se alegue sigilo para não prestar informações a uma Comissão de Ética, que por sua vez, resguardará o sigilo das informações recebidas.' },
        { id: "Q20", question: 'As instâncias superiores estão dispensadas de garantir recursos para as Comissões de Ética, que devem se manter com recursos próprios.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'É dever das instâncias superiores dos órgãos e entidades garantir os recursos humanos, materiais e financeiros para que a respectiva Comissão de Ética cumpra suas atribuições.' },
    ],
    constitucional: [
        { id: "Q21", question: 'A obtenção de certidões em repartições públicas, para esclarecimento de situação de interesse pessoal, é direito assegurado a todos e independe do pagamento de taxa.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Conforme o Art. 5º, XXXIV, "b", da Constituição Federal, é assegurado a todos, independentemente do pagamento de taxas, a obtenção de certidões para a defesa de direitos e esclarecimento de situações de interesse pessoal.' },
        { id: "Q22", question: 'O Poder Judiciário pode determinar a implantação de políticas públicas relacionadas a direitos e garantias fundamentais, sem que isso ofenda o princípio da separação dos poderes.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O STF já decidiu que, em casos excepcionais e para garantir o mínimo existencial, o Judiciário pode determinar a implementação de políticas públicas sem violar a separação dos poderes.' },
        { id: "Q23", question: 'O Fundo de Garantia do Tempo de Serviço é direito tanto dos trabalhadores urbanos quanto dos trabalhadores rurais.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O Art. 7º da Constituição Federal elenca os direitos dos trabalhadores urbanos e rurais, incluindo o FGTS no inciso III.' },
    ...
    administrativo: [
        ...
        { id: "Q28", question: 'Servidor público da administração indireta investido no mandato de vereador poderá acumular as vantagens do emprego com a remuneração do cargo eletivo, se houver compatibilidade de horários.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'A Constituição, no Art. 38, III, permite a acumulação de remunerações quando há compatibilidade de horários entre o cargo público e o mandato de vereador.' },
        { id: "Q29", question: 'Os vencimentos dos cargos integrantes dos Poderes Legislativo e Judiciário não poderão exceder os pagos aos cargos do Poder Executivo.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Este é o princípio da isonomia de vencimentos entre os Poderes, estabelecido no Art. 37, XII, da Constituição Federal, que define subtetos remuneratórios.' },
        { id: "Q30", question: 'Agente público ocupante de cargo temporário não está submetido ao Regime Geral de Previdência Social.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'O servidor ocupante de cargo exclusivamente em comissão, de cargo temporário ou de emprego público vincula-se obrigatoriamente ao Regime Geral de Previdência Social (RGPS).' },
        { id: "Q31", question: 'A transmissão de competência de uma pessoa jurídica de direito público para outra configura a desconcentração.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A transmissão de competência entre diferentes pessoas jurídicas é a descentralização (ex: da União para uma Autarquia). A desconcentração é a distribuição interna de competências dentro da mesma pessoa jurídica (ex: de um Ministério para uma Secretaria).' },
        { id: "Q32", question: 'O ato administrativo praticado por agente público no exercício da sua função expressa o sentido objetivo da administração pública.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'Expressa o sentido subjetivo. O sentido subjetivo (ou formal) refere-se a quem exerce a função (os órgãos, entidades e agentes). O sentido objetivo (ou material) refere-se à atividade em si (fomento, poder de polícia, etc.).' },
        { id: "Q33", question: 'A regulamentação e a fiscalização de atividade econômica de natureza privada pela administração pública caracterizam a intervenção.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Esta é uma forma de intervenção do Estado no domínio econômico, exercida principalmente através do poder de polícia.' },
        { id: "Q34", question: 'Os jurados, embora colaborem temporariamente com a administração pública, não podem ser considerados agentes públicos.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'Os jurados são considerados agentes honoríficos. Eles prestam um serviço público relevante (munus publicum) e, enquanto atuam, são considerados agentes públicos.' },
        { id: "Q35", question: 'Por meio do poder regulamentar, cabe à administração pública criar mecanismos de complementação das leis, a fim de possibilitar a sua efetiva aplicabilidade.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Esta é a função do poder regulamentar: expedir decretos e regulamentos para dar fiel execução às leis, detalhando sua aplicação.' },
        { id: "Q36", question: 'A condição de acionista de sociedade privada impede a posse em cargo público.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A Lei 8.112/90 permite ao servidor participar como acionista ou cotista de sociedade privada, desde que não participe da gerência ou administração.' },
        { id: "Q37", question: 'A delegação de competência de um titular a outro depende da existência de subordinação hierárquica.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A delegação de competência não exige hierarquia entre o delegante e o delegado, conforme previsto na Lei nº 9.784/99.' },
        { id: "Q38", question: 'A concessão administrativa se dá quando seu objeto é a prestação de serviço do qual a administração pública seja a usuária, ainda que indireta.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Esta é a definição de concessão administrativa no âmbito das parcerias público-privadas (PPP), conforme a Lei nº 11.079/2004.' },
        { id: "Q39", question: 'A voluntariedade do agente é suficiente para caracterizar a conduta ilícita como crime de improbidade administrativa.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'Com as alterações da Lei 14.230/2021, os atos de improbidade administrativa agora exigem a comprovação de dolo (intenção) do agente. A culpa não é mais suficiente.' },
        { id: "Q40", question: 'O direito de petição, por meio do qual as pessoas podem formular postulações aos órgãos públicos, é um meio de controle administrativo.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O direito de petição é um instrumento de controle exercido pelos administrados sobre a Administração Pública, provocando a atuação e fiscalização dos órgãos.' },
    ],
    informatica: [
    ...
    seguridade: [
        ...
        { id: "Q52", question: 'A Constituição outorgada por Getúlio Vargas em 1937, conhecida como Constituição Polaca, é considerada o marco do direito previdenciário brasileiro.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'O marco da previdência no Brasil é a Lei Eloy Chaves, de 1923, que criou as Caixas de Aposentadorias e Pensões para os ferroviários.' },
        { id: "Q53", question: 'Os benefícios e serviços prestados pela seguridade social são exclusivos daqueles que participam do seu custeio.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A Seguridade Social abrange a Saúde e a Assistência Social, que são prestadas independentemente de contribuição, e a Previdência Social, que exige contribuição.' },
        { id: "Q54", question: 'O princípio da seguridade social que estabelece que a contribuição social para o custeio deve ser proporcional à condição financeira dos seus contribuintes denomina-se equidade na forma de participação no custeio.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Este princípio determina que quem tem mais capacidade econômica deve contribuir com mais, garantindo justiça no financiamento.' },
        { id: "Q55", question: 'A assistência social integra a seguridade social, cujos programas são coordenados e executados pelas esferas estadual e municipal, com recursos do orçamento da seguridade social, bem como por entidades beneficentes.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'A gestão da assistência social é descentralizada, com participação dos entes federativos e de entidades da sociedade civil, conforme previsto na Constituição.' },
        { id: "Q56", question: 'Caso haja lacuna na legislação, o intérprete poderá valer-se de analogia, costumes e princípios gerais do direito como instrumentos integrativos para resolver questões referentes a matéria previdenciária.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O artigo 4º da Lei de Introdução às Normas do Direito Brasileiro (LINDB) permite o uso de analogia, costumes e princípios gerais de direito para suprir omissões na lei.' },
        { id: "Q57", question: 'O dependente do segurado do RGPS pode, nessa condição, efetuar a sua inscrição junto ao INSS no momento em que este tiver de se habilitar ao recebimento do benefício a que faz jus.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'A inscrição do dependente é realizada quando do requerimento do benefício a que tiver direito, não sendo necessário um ato prévio.' },
        { id: "Q58", question: 'Presentes os pressupostos da filiação, é admitida a inscrição post mortem de segurado contribuinte individual e de segurado facultativo, mas não de segurado especial.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A inscrição post mortem é permitida para o segurado especial, desde que se comprove o exercício da atividade rural no período anterior ao falecimento.' },
        { id: "Q59", question: 'Um estudante de quinze anos de idade não pode se inscrever no RGPS na condição de segurado facultativo.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A idade mínima para filiação como segurado facultativo é de 16 anos. O aprendiz pode se filiar a partir dos 14 anos como segurado obrigatório.' },
        { id: "Q60", question: 'Um decreto do Executivo federal pode criar um novo benefício previdenciário e aumentar a contribuição para arcar com seu custeio.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A criação de benefícios e a majoração de contribuições previdenciárias dependem de lei em sentido estrito, não podendo ser feitas por decreto.' },
        { id: "Q61", question: 'Servidor público de carreira de um estado, nomeado para cargo em comissão em fundação federal, optando pela remuneração do cargo efetivo, passa a ser segurado obrigatório do RGPS.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Servidor público ocupante exclusivamente de cargo em comissão é segurado obrigatório do RGPS.' },
        { id: "Q62", question: 'O proprietário de uma fazenda produtiva que contrata um caseiro é considerado, para fins previdenciários, empregador doméstico.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A atividade tem fins lucrativos (produção de leite e gado), o que descaracteriza o trabalho doméstico. O contratante é um empregador rural.' },
        { id: "Q63", question: 'Flávio, servidor público federal, que exerce atividade como motorista de aplicativo para complementar a renda, é considerado segurado obrigatório do RGPS por essa atividade.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Qualquer pessoa que exerça atividade remunerada abrangida pelo RGPS é segurada obrigatória, mesmo que já seja vinculada a um Regime Próprio de Previdência.' },
        { id: "Q64", question: 'Pedro, que trabalhou por 20 anos, deixou de exercer atividade remunerada para se dedicar ao lar. Ele poderá manter o vínculo com o RGPS após o período de graça, filiando-se como segurado facultativo.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Qualquer pessoa maior de 16 anos que não exerça atividade remunerada que a enquadre como segurada obrigatória pode se filiar como facultativo.' },
        { id: "Q65", question: 'Matilde, que faz da pesca artesanal seu principal meio de vida, pode se inscrever no RGPS como segurada facultativa.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'Como pescadora artesanal, Matilde se enquadra na categoria de segurada especial, que é uma modalidade de segurado obrigatório, não podendo ser facultativa.' },
        { id: "Q66", question: 'A licença-prêmio indenizada integra o salário de contribuição.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'Conforme entendimento consolidado do STJ (Tema 737), as verbas de natureza indenizatória, como a licença-prêmio não gozada, não integram o salário de contribuição.' },
        { id: "Q67", question: 'As igrejas e os templos de qualquer culto são isentos de contribuições para a seguridade social.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'A Constituição Federal (Art. 195, § 7º) estabelece a isenção de contribuição para a seguridade social para as entidades beneficentes de assistência social, o que inclui templos de qualquer culto que atendam às exigências em lei.' },
        { id: "Q68", question: 'Os devedores da previdência social não podem receber benefícios ou incentivos fiscais ou creditícios do Estado.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'O Art. 195, § 3º da Constituição Federal proíbe que a pessoa jurídica em débito com a seguridade social contrate com o Poder Público ou dele receba benefícios.' },
        { id: "Q69", question: 'Os contribuintes individual e facultativo podem optar pela alíquota de 11% sobre o salário mínimo caso renunciem ao direito à aposentadoria por tempo de contribuição.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Esta é a regra do plano simplificado de Previdência Social, que permite uma contribuição menor em troca da exclusão do direito à aposentadoria por tempo de contribuição.' },
        { id: "Q70", question: 'O percentual incidente sobre o resultado dos leilões dos bens apreendidos pela Receita Federal é fonte de receita da seguridade social.', answer: 'Certo', law: 'INSS 2022', isConcurso: true, explanation: 'Conforme a Lei 8.212/91, Art. 27, esta é uma das diversas fontes de receita que financiam a seguridade social.' },
        { id: "Q71", question: 'Os trabalhadores avulsos que prestam serviços a empresas devem recolher as contribuições à previdência social por conta própria.', answer: 'Errado', law: 'INSS 2022', isConcurso: true, explanation: 'A responsabilidade pelo recolhimento da contribuição do trabalhador avulso que presta serviço a empresas é da própria empresa tomadora do serviço, não do trabalhador.' },
